	...
	function continuously_view(){
		$('article[role=article]').each(function(i,el){
			if(!$(el).parent().parent().hasClass('activated_vizonator')){
				...
				$(el).find('div[role=group]').after('<div class="vizonator_div"><div class="vizonator_button" data-id="'+vizonator_counter+'">'+vizonator_icon+' Award</div><div class="vizonator_status"></div></div>');
