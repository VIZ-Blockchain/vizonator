var ltmp_ru_arr={
	...
	form_key_keep:'Поля ключей пустые намеренно: приватные ключи не покидают ядро расширения. Оставьте поле пустым — сохранённый ключ не изменится, впишите новый — ключ будет заменён.',
	...
	transfer_template_solana:'VIZ в Solana через gateway.viz.cx',
	transfer_template_regular:'Обычный перевод VIZ',
	transfer_template_ton_hint:'Получатель gram.gate заполнен автоматически. Введите TON-адрес в поле заметки без префиксов и дополнительных символов. Комиссия шлюза: максимум из 45 VIZ или 0,2%; для нового адреса разовая доплата 37,5 VIZ. Минимальная сумма перевода: 46 VIZ; для нового адреса — 83,5 VIZ. Если перевод не дойдёт, шлюз вернёт его за вычетом 5 VIZ.',
	transfer_template_solana_hint:'Получатель solana.gate заполнен автоматически. Введите адрес Solana в поле заметки — точно и без дополнительного текста. Комиссия шлюза: максимум из 10 VIZ или 0,2%; для нового адреса разовая доплата 40 VIZ. Минимальная сумма перевода: 11 VIZ; для нового адреса — 51 VIZ. Если перевод не дойдёт, шлюз вернёт его за вычетом 5 VIZ.',
	transfer_template_ton_hint_base:'Получатель gram.gate заполнен автоматически. Введите TON-адрес в поле заметки без префиксов и дополнительных символов.',
	transfer_template_solana_hint_base:'Получатель solana.gate заполнен автоматически. Введите адрес Solana в поле заметки — точно и без дополнительного текста.',
	transfer_template_fee_line:'Комиссия шлюза: максимум из {floor} VIZ или {bps}%; для нового адреса разовая доплата {surcharge} VIZ. Минимальная сумма перевода: {min} VIZ; для нового адреса — {min_new} VIZ.',
	transfer_template_refund_line:'Если перевод не дойдёт, шлюз вернёт его за вычетом {refund} VIZ.',
	...
	transfer_template_solana_memo:'Адрес Solana получателя',
	transfer_template_ton_memo_error:'Для перевода через gram.gate укажите TON-адрес в поле заметки без префикса #.',
	transfer_template_solana_memo_error:'Для перевода через solana.gate укажите адрес Solana в поле заметки без префикса # и дополнительного текста.',
	transfer_gateway_checking:'Проверяю состояние шлюзов TON и Solana…',
	transfer_gateway_unavailable:'Состояние шлюзов подтвердить не удалось. Шлюзовые шаблоны временно скрыты; доступен обычный перевод.',
	...
	encode_memo_yes:'Заметка будет зашифрована ✔️',
	encode_memo_no:'⚠️ Заметка НЕ будет зашифрована — её сможет прочитать кто угодно через блокчейн обозреватель',
	...
	operations_caption:{
		...
		pm_cancel_bet:'Отмена ставки',
		pm_add_liquidity:'Добавить ликвидность',
		pm_withdraw_liquidity:'Вывести ликвидность',
		pm_resolve_market:'Резолв рынка',
		pm_no_contest:'Отмена рынка (no contest)',
		pm_dispute_create:'Открыть спор',
		pm_dispute_vote:'Голос в споре',
		pm_dispute_resolve:'Решение спора',
		pm_dispute_oracle_respond:'Ответ оракула в споре',
		pm_unban:'Снять бан',
		pm_transfer_position:'Передача позиции',
		pm_lazy_deposit:'Депозит в пул',
		pm_lazy_withdraw:'Вывод из пула',
		pm_leverage_open:'Открыть плечо',
		pm_leverage_close:'Закрыть плечо',
		pm_leverage_convert:'Конвертировать плечо',
	},
	prediction_market_caption:'Рынок предсказаний'
};