var ltmp_ru_arr={
	...
	transfer_template_solana_hint:'Получатель solana.gate заполнен автоматически. Введите адрес Solana в поле заметки — точно и без дополнительного текста. Комиссия шлюза: максимум из 10 VIZ или 0,2%; для нового адреса Solana разовая доплата 40 VIZ.',
