var ltmp_ru_arr={
	...
	transfer_template_ton_hint:'Получатель gram.gate заполнен автоматически. Введите TON-адрес в поле заметки без префиксов и дополнительных символов. Комиссия шлюза: максимум из 45 VIZ или 0,2%; для нового адреса разовая доплата 37,5 VIZ. Минимальная сумма перевода: 46 VIZ; для нового адреса — 83,5 VIZ.',
	transfer_template_solana_hint:'Получатель solana.gate заполнен автоматически. Введите адрес Solana в поле заметки — точно и без дополнительного текста. Комиссия шлюза: максимум из 10 VIZ или 0,2%; для нового адреса разовая доплата 40 VIZ. Минимальная сумма перевода: 11 VIZ; для нового адреса — 51 VIZ.',
